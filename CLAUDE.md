...
- **M5 Fake Specs + Dual PNG Export** (next code milestone) → **M6 Landing/QA/Deploy**: write `docs/superpowers/plans/2026-06-02-specs-and-export.md` immediately before starting M5.
